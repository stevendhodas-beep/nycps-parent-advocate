...
const RESPONSES: Record<ReturnType<typeof detectIntent>, (message: string) => object> = {
  iep: (message) => ({
    ...
    summary:
      ...
      "Would you like me to request a CSE meeting or send a message to the Special Education coordinator?",
  ...
  tutoring: (message) => ({
    ...
    summary:
      ...
      "I can enroll your child in the after-school program or send you the registration forms for any of these.",
    ambiguities: [],
  }),
  ...
  medical: (message) => ({
    ...
    summary:
      ...
      "Would you like to update any health information or notify a new school about your child's condition?",
    ambiguities: [],
  }),
  ...
  enrollment: (message) => ({
    ...
    summary:
      ...
      "• Your Parent Coordinator at PS 123 (Ms. Johnson) can walk you through the process in person.\n\n" +
  ...
  attendance: (message) => ({
    ...
    summary:
      ...
      "Is there anything you'd like to report or dispute?",
    ambiguities: [],
  }),
  ...
  general: (message) => ({
    ...
    summary:
      ...
      "Your Parent Coordinator (Ms. Johnson) is available Mon–Fri 8 AM–3 PM if you need to speak with someone directly.",
